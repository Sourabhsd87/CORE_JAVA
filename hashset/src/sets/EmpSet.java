...
public class EmpSet {
	...
	public static void main(String[] args) {
		Emp e1=new Emp("rnd-001", "Riya", 10000,"05");
		Emp e2=new Emp("rnd-003", "Rakesh", 20000,"06");
		Emp e3=new Emp("rnd-007", "Riya", 10000,"05");
		Emp e4=new Emp("rnd-004", "Riya", 10000,"07");
		Emp e5=new Emp("rnd-002", "Rakesh", 20000,"08");
		Emp e6=new Emp("rnd-008", "Riya", 10000,"09");
